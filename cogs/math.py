...
class MathCog(commands.Cog):
    ...
    async def math(self, ctx, *, inp: str):
        """Does math. Uses python syntax with math library. Use like math 5 + 3 * 2 or math [function](5). To get
        list of all functions use math_functions command. """
        if inp == "":
